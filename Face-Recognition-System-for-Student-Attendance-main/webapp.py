...
cred = credentials.Certificate("D:/BAO/WED/Face-Recognition-System-for-Student-Attendance-main/Face-Recognition-System-for-Student-Attendance-main/misc/serviceAccountKey.json")
firebase_admin.initialize_app(
    cred,
    {
        'databaseURL':"https://faceattendancerealtime-ea458-default-rtdb.firebaseio.com/",
        'storageBucket': "faceattendancerealtime-ea458.appspot.com"
    },
)
...
def dataset(id):
    ...
    blob = bucket.get_blob(f"D:/BAO/WED/Face-Recognition-System-for-Student-Attendance-main/Face-Recognition-System-for-Student-Attendance-main/static/Files/Images/{id}.jpg")
...
def generate_frame():
    ...
    imgBackground = cv2.imread("D:/BAO/WED/Face-Recognition-System-for-Student-Attendance-main/Face-Recognition-System-for-Student-Attendance-main/static/Files/Resources/background.png")

    folderModePath = "D:/BAO/WED/Face-Recognition-System-for-Student-Attendance-main/Face-Recognition-System-for-Student-Attendance-main/static/Files/Resources/Modes/"
...
def student_attendance_list():
    ...
    return render_template("student_attendance.html", data=student_info)
...
@app.route("/admin/admin_attendance", methods=["GET", "POST"])
def admin_attendance_list():
    if request.method == "POST":
        ...
        for i in unique_id_admin:
            student_info.append(dataset(i))
        return render_template("admin_attendance.html", data=student_info)
...
def add_image_database():
    folderPath = "D:/BAO/WED/Face-Recognition-System-for-Student-Attendance-main/Face-Recognition-System-for-Student-Attendance-main/static/Files/Images"
...
def add_user():
    ...
    if request.method == "POST":
        ...
        filename = f"{'D:/BAO/WED/Face-Recognition-System-for-Student-Attendance-main/Face-Recognition-System-for-Student-Attendance-main/static/Files/Images'}/{id}.jpg"
